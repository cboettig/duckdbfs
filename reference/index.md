...
- [`to_h3j()`](https://cboettig.github.io/duckdbfs/reference/to_h3j.md)
  ...
  Write H3 hexagon data out as an h3j-compliant JSON file NOTE: the
  column containing H3 hashes must be named `hexid`

- [`to_json()`](https://cboettig.github.io/duckdbfs/reference/to_json.md)
