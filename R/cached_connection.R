...
#' @param with_spatial install (if missing) and load spatial extension, default FALSE
...
#' @param with_h3 install (if missing) and load  the h3 spatial index extension.  Default FALSE
