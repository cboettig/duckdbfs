...
Note that `duckdbfs` automatically handles creating and handling the database connection object.
It is optional but best practice to explicitly close the connection at the end of any script using `duckdbfs`, which avoids the warning that this connection is garbage-collected.
